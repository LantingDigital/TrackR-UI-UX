...
export const FeaturedParkCard = React.memo<FeaturedParkCardProps>(({
  ...
  const entryStyle = useAnimatedStyle(() => ({
    ...
    transform: [
      { scale: 0.92 + entryProgress.value * 0.08 },
      { translateY: (1 - entryProgress.value) * 24 },
    ],
  }));
      ...
      <Animated.View style={[entryStyle, animatedStyle]}>
        ...
        >
          <View style={styles.imageWrapper}>
            <Image source={{ uri: data.imageUrl }} style={styles.heroImage} contentFit="cover" cachePolicy="memory-disk" />
            <LinearGradient
