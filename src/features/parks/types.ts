...
export type ParkArea =
  ...
  | 'celestial-park'
  | 'super-nintendo-world-eu'
  | 'dark-universe'
  | 'wizarding-world-ministry'
  | 'isle-of-berk'
  ...
  | 'lego-city-llf'
  | 'heartlake-city-llf'
  | 'imagination-zone-llf'
  | 'lego-movie-world-llf'
  | 'lego-ninjago-world-llf'
  | 'lego-kingdoms-llf'
  | 'land-of-adventure-llf'
  | 'castle-hill-llf'
  | 'miniland-usa-llf'
  | 'lego-technic-llf'
  | 'cypress-gardens-llf'
  ...
  | 'spassburg'
  | 'los-festivales'
  | 'screampunk-district-sfft'
  | 'dc-universe-sfft'
  | 'lone-star-lil-kids-area'
  ...
  // Hollywood Studios
  | 'hollywood-boulevard-hs'
  | 'echo-lake-hs'
  | 'star-wars-galaxys-edge-hs'
  | 'toy-story-land-hs'
  | 'animation-courtyard-hs'
  | 'sunset-boulevard-hs'
  | 'grand-avenue-hs'
  // Animal Kingdom
  | 'discovery-island-ak'
