/**
 * TriviaHeader — Close + Title + MorphingPill settings gear
 *
...
import { TriviaSettingsContent } from './TriviaSettingsContent';
import type { TriviaStats } from '../types/trivia';
import type { TriviaSettings } from '../stores/triviaStore';
import { setHardMode } from '../stores/triviaStore';
