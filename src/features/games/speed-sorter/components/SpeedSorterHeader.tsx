/**
 * SpeedSorterHeader — Close + Title + MorphingPill settings gear
 *
...
import { SpeedSorterSettingsContent } from './SpeedSorterSettingsContent';
import type { SpeedSorterStats } from '../types/speedSorter';
import type { SpeedSorterSettings } from '../stores/speedSorterStore';
import { setHardMode, setShowTimer } from '../stores/speedSorterStore';
...
interface SpeedSorterHeaderProps {
  onClose: () => void;
  stats: SpeedSorterStats;
  settings: SpeedSorterSettings;
}

export const SpeedSorterHeader: React.FC<SpeedSorterHeaderProps> = ({
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + spacing.xs }]}>
      ...
      <View style={styles.center}>
        <Text style={styles.title}>SPEED SORTER</Text>
      </View>
      ...
      <MorphingPill
        ...
        expandedContent={(close) => (
          <SpeedSorterSettingsContent
            stats={stats}
            settings={settings}
            onSetHardMode={setHardMode}
            onSetShowTimer={setShowTimer}
            close={close}
          />
        )}
        onOpen={handleOpen}
