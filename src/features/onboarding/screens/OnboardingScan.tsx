/**
 * OnboardingScan — Screen 4 of onboarding.
 * Same embedded approach as OnboardingSearch/Log but demos the Scan/Wallet flow.
 * Auto-demos: Scan button → wallet carousel → flip passes → close → loop
 */
...
export const OnboardingScan: React.FC<OnboardingScreenProps> = ({ isActive }) => {
        ...
        <View style={styles.phoneFrame}>
          ...
          <View style={styles.phoneInner}>
            <View
              ...
              pointerEvents="none"
            >
              <OnboardingSearchEmbed isActive={isActive} demoMode="scan" />
            </View>
          </View>
        </View>
      </View>
