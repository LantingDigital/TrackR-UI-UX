...
const EDGES: MapEdge[] = [
  ...
  { from: 'ride-great-pumpkin-coaster', to: 'w-planet-snoopy', weight: 1 },
  { from: 'ride-snoopys-soap-box-racers', to: 'w-planet-snoopy', weight: 1 },
  { from: 'ride-grand-carousel', to: 'w-coney-mall-west', weight: 1 },
  { from: 'ride-dodgem-ki', to: 'w-coney-mall-east', weight: 1 },
  { from: 'ride-white-water-canyon', to: 'w-rivertown-west', weight: 1 },
  { from: 'ride-congo-falls', to: 'w-action-zone-south', weight: 1 },
  { from: 'food-chicken-shack', to: 'w-rivertown-west', weight: 1 },
  { from: 'food-panda-express-ki', to: 'w-action-zone-south', weight: 1 },
  { from: 'food-hanks-burrito-shack', to: 'w-action-zone-north', weight: 1 },
  { from: 'food-tom-and-chee', to: 'w-coney-mall-east', weight: 1 },
  { from: 'food-reds-hall-of-fame-grille', to: 'w-coney-mall-east', weight: 1 },
  { from: 'food-festhaus', to: 'w-oktoberfest', weight: 1 },
  { from: 'food-dippin-dots-ki', to: 'w-coney-mall-east', weight: 1 },
  { from: 'shop-emporium-ki', to: 'w-international-street', weight: 1 },
  { from: 'shop-orion-gear', to: 'w-area-72', weight: 1 },
  { from: 'shop-beast-shop', to: 'w-rivertown-east', weight: 1 },
  { from: 'shop-planet-snoopy-store', to: 'w-planet-snoopy', weight: 1 },
  { from: 'shop-international-gifts', to: 'w-international-street', weight: 1 },
  { from: 'attraction-eiffel-tower', to: 'w-fountain-plaza', weight: 1 },
  { from: 'attraction-kings-island-theater', to: 'w-international-street', weight: 1 },
  { from: 'attraction-festhaus-stage', to: 'w-oktoberfest', weight: 1 },
  { from: 'attraction-soak-city-entrance', to: 'w-rivertown-east', weight: 1 },
  { from: 'attraction-phantom-theater', to: 'w-rivertown-west', weight: 1 },
  { from: 'service-atm-ki', to: 'w-entrance-ki', weight: 1 },
  { from: 'service-lockers-ki', to: 'w-entrance-ki', weight: 1 },
];
