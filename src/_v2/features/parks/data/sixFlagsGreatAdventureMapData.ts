...
const EDGES: MapEdge[] = [
  ...
  { from: 'ride-cyborg-cyber-spin', to: 'w-movietown-north', weight: 1 },
  { from: 'ride-scrambler', to: 'w-fantasy-forest', weight: 1 },
  { from: 'ride-twister', to: 'w-fantasy-forest', weight: 1 },
  { from: 'ride-houdini', to: 'w-movietown-south', weight: 1 },
  { from: 'food-granny-bs', to: 'w-frontier-south', weight: 1 },
  { from: 'food-cold-stone-sfga', to: 'w-main-street', weight: 1 },
  { from: 'food-big-wheel-pizza', to: 'w-fantasy-forest', weight: 1 },
  { from: 'shop-main-gate-shop', to: 'w-entrance-sfga', weight: 1 },
  { from: 'shop-justice-league-store', to: 'w-movietown-north', weight: 1 },
  { from: 'shop-frontier-trading-post-sfga', to: 'w-frontier-south', weight: 1 },
];
