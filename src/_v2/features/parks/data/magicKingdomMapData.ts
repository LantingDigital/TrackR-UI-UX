...
const EDGES: MapEdge[] = [
  ...
  { from: 'shop-emporium-mk', to: 'w-main-street', weight: 1 },
  { from: 'shop-memento-mori', to: 'w-liberty-square', weight: 1 },
  { from: 'shop-big-top-souvenirs', to: 'w-fantasyland-east', weight: 1 },
  { from: 'shop-merchant-of-venus', to: 'w-tomorrowland-south', weight: 1 },
];
