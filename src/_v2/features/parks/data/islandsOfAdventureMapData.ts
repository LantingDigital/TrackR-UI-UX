...
const EDGES: MapEdge[] = [
  ...
  { from: 'shop-honeydukes', to: 'w-lost-continent', weight: 1 },
  { from: 'shop-ollivanders', to: 'w-hogsmeade', weight: 1 },
  { from: 'shop-filchs-emporium', to: 'w-hogsmeade', weight: 1 },
  { from: 'shop-marvel-alterniverse', to: 'w-marvel', weight: 1 },
  { from: 'shop-jurassic-outfitters', to: 'w-jurassic', weight: 1 },
  { from: 'shop-port-of-entry-gifts', to: 'w-port-of-entry', weight: 1 },
];
