...
const EDGES: MapEdge[] = [
  ...
  { from: 'ride-scrambler', to: 'w-movie-district-center', weight: 1 },
  { from: 'ride-buccaneer', to: 'w-movie-district-center', weight: 1 },
  { from: 'ride-swashbuckler', to: 'w-movie-district-center', weight: 1 },
  { from: 'ride-wonder-woman-lasso', to: 'w-dc-universe-north', weight: 1 },
  { from: 'ride-the-flash', to: 'w-dc-universe-south', weight: 1 },
  { from: 'ride-sky-tower', to: 'w-movie-district-center', weight: 1 },
  { from: 'ride-grand-carousel-mm', to: 'w-movie-district-center', weight: 1 },
  { from: 'food-cold-stone-mm', to: 'w-dc-universe-south', weight: 1 },
  { from: 'food-dc-eats', to: 'w-dc-universe-north', weight: 1 },
  { from: 'food-dippin-dots-mm', to: 'w-movie-district-center', weight: 1 },
  { from: 'shop-main-gate-shop-mm', to: 'w-entrance-mm', weight: 1 },
  { from: 'shop-twisted-colossus-shop', to: 'w-screampunk-north', weight: 1 },
  { from: 'shop-dc-universe-store', to: 'w-dc-universe-south', weight: 1 },
  { from: 'shop-tatsu-gift-shop', to: 'w-samurai-summit', weight: 1 },
  { from: 'shop-looney-tunes-store', to: 'w-looney-tunes', weight: 1 },
  { from: 'attraction-dc-universe-stage', to: 'w-dc-universe-north', weight: 1 },
  { from: 'attraction-movie-district-theater', to: 'w-movie-district-center', weight: 1 },
  { from: 'attraction-midway-games-mm', to: 'w-movie-district-center', weight: 1 },
  { from: 'attraction-hurricane-harbor', to: 'w-cyclone-bay', weight: 1 },
  { from: 'service-atm-mm', to: 'w-entrance-mm', weight: 1 },
  { from: 'service-lockers-mm', to: 'w-entrance-mm', weight: 1 },
];
