...
const EDGES: MapEdge[] = [
  ...
  { from: 'ride-phoenix', to: 'w-egypt-north', weight: 1 },
  { from: 'ride-skyride-bgt', to: 'w-congo', weight: 1 },
  { from: 'ride-serengeti-express', to: 'w-nairobi', weight: 1 },
  { from: 'food-twisted-tails-pretzels', to: 'w-congo', weight: 1 },
  { from: 'food-rescue-cafe', to: 'w-nairobi', weight: 1 },
  { from: 'food-dippin-dots-bgt', to: 'w-pantopia-north', weight: 1 },
  { from: 'shop-marrakesh-market', to: 'w-morocco', weight: 1 },
  { from: 'shop-xcursions', to: 'w-entrance-bgt', weight: 1 },
  { from: 'shop-sheikra-shop', to: 'w-stanleyville', weight: 1 },
  { from: 'shop-emporium-bgt', to: 'w-bird-gardens', weight: 1 },
  { from: 'attraction-serengeti-safari', to: 'w-nairobi', weight: 1 },
  { from: 'attraction-edge-of-africa', to: 'w-egypt-south', weight: 1 },
  { from: 'attraction-moroccan-palace-theater', to: 'w-morocco', weight: 1 },
  { from: 'attraction-gwazi-gliders', to: 'w-pantopia-south', weight: 1 },
];
