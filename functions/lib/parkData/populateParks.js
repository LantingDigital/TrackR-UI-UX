...
function estimateRadiusMeters(parkName) {
    ...
    if (name.includes('magic kingdom') ||
        name.includes('epcot') ||
...
// Cloud Function
// ============================================
exports.populateParks = (0, https_1.onCall)({
    region: 'us-central1',
    memory: '1GiB',
    ...
    for (const dest of destinations) {
        ...
        for (const parkRef of dest.parks) {
            try {
                ...
                console.log(`[populateParks] ${parkEntity.name}: ${children.length} children written`);
...
//# sourceMappingURL=populateParks.js.map