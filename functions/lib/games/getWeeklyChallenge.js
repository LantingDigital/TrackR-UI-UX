...
exports.getWeeklyChallenge = void 0;
 ...
 */
function getRotationIndex(weekStart) {
    const epoch = new Date('2025-01-06T00:00:00Z');
    const weekMs = 7 * 24 * 60 * 60 * 1000;
    const weeksSinceEpoch = Math.floor((weekStart.getTime() - epoch.getTime()) / weekMs);
    return Math.abs(weeksSinceEpoch) % CHALLENGE_ROTATION.length;
}
// ============================================
// Cloud Function
// ============================================
exports.getWeeklyChallenge = (0, https_1.onCall)({
    region: 'us-central1',
    memory: '256MiB',
    timeoutSeconds: 10,
}, async (request) => {
    ...
    if (progressSnap.exists) {
        ...
        progress = { ...newProgress, startedAt: new Date() };
    }
    return { challenge, progress };
});
//# sourceMappingURL=getWeeklyChallenge.js.map