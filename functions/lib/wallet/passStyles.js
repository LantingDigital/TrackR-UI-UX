...
exports.PASS_TYPE_LABELS = exports.PARK_BRAND_COLORS = exports.PASS_STYLE_CONFIGS = void 0;
exports.getParkBrandColor = getParkBrandColor;
exports.getPassTypeLabel = getPassTypeLabel;
// ============================================
// Style Configurations
// ============================================
exports.PASS_STYLE_CONFIGS = {
    clean: {
 ...
 */
function getParkBrandColor(parkChain) {
    const normalized = parkChain.toLowerCase().trim();
    return exports.PARK_BRAND_COLORS[normalized] ?? exports.PARK_BRAND_COLORS.other;
}
// ============================================
// Pass Type Labels
// ============================================
...
function getPassTypeLabel(passType) {
    return exports.PASS_TYPE_LABELS[passType] ?? exports.PASS_TYPE_LABELS.unknown;
}
//# sourceMappingURL=passStyles.js.map