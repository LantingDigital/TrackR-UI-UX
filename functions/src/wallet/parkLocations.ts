 ...
 */
const PARK_LOCATIONS: Record<string, ParkLocation> = {
  // Cedar Fair
 ...
 */
function normalizeParkName(parkName: string): string {
  return parkName
    .toLowerCase()
 ...
 */
export function findParkLocation(parkName: string): ParkLocation | null {
